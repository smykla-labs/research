...
For detailed step-by-step investigation process, see **[Investigation Workflow](investigation-workflow.md)**.
...
Finding the right selectors is critical. See **[Element Selectors](element-selectors.md)** for comprehensive guidance.
...
The right tool depends on your requirements. See **[Tool Comparison](tool-comparison.md)** for detailed analysis.
...
For more scenarios, see **[Investigation Workflow](investigation-workflow.md)**.

## Debugging

When automation fails, systematic debugging saves time. See **[Debugging Techniques](debugging-techniques.md)**.
...
Avoid these common mistakes. See **[Common Pitfalls](common-pitfalls.md)** for detailed solutions.
...
Reusable code templates for common operations. See **[Code Patterns](code-patterns.md)**.
...
def wait_for_element(page, selector, timeout=10):
    ...
    # Wait for element to stop moving (animations, layouts)
...
- **⭐ [Practical Debugging Workflow](practical-debugging-workflow.md)** - **START HERE** - Real-world investigation feedback loop, browser-controller integration, efficient debugging (MUST READ for rapid debugging)
- **[Investigation Workflow](investigation-workflow.md)** - Detailed 8-phase process
- **[Element Selectors](element-selectors.md)** - Selector strategies and patterns
- **[Tool Comparison](tool-comparison.md)** - Playwright vs Selenium vs Puppeteer vs MCP
- **[Common Pitfalls](common-pitfalls.md)** - Known issues and solutions
