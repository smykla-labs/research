...
- **`worktree-creator.md`** - Creates git worktree at `../{project}-{branch}` with context transfer. Discovers remote/default-branch, copies relevant files, outputs `cd` command to clipboard.
